                    ...
                    <div class="profile-box latest-activity card" >
                        ...
                        <div class="content activities p-4">
                            <table class="table-responsive" border="1" align="center">
                                <tbody>
                                    <tr align="center">
                                        <td colspan="7"><strong>Compra de Derecho Servicio Extra -> {{$csextra->ServicioExtra->sextra_desc}}</strong></td>
                                    </tr>
                                    <tr align="center">
                                        <td>Monto</td>
                                        <td>Solicitante</td>
                                    ...
                                    <tr align="center">
                                        ...
                                        <td>{{$csextra->Contrato->Nicho->nicho_nro}}</td>
                                        <td>@php echo $filaenletra; @endphp</td>
                                        <td>{{$csextra->Contrato->Nicho->Pabellon->pab_nom}}</td>
                                        <td>{{$csextra->Contrato->Nicho->Pabellon->Cementerio->cement_nom}}</td>
