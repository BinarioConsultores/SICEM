                    ...
                    <div class="example">
                        <div class="m-1">
                            ...
                            <div class="content p-4">
                                <div class="row">
                                    <div class="col-6 p-8">
                                        <a href="/createPDF?conv_id={{$contrato->conv_id}}"><button type="button"   class="btn btn-primary fuse-ripple-ready">Imprimir
                                        </button></a>
                                    </div>
                                    <div class="col-6 p-8">
                                        <a href="/createN?conv_id={{$contrato->conv_id}}"><button type="button"   class="btn btn-primary fuse-ripple-ready">Notificar
                                        </button></a>
                                    </div>
                                </div>
                            </div>
