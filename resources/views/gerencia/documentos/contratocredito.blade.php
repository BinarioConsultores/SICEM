...
<html lang="es">
  ...
  <body>
      ...
      <p style="text-align: justify;"><FONT FACE="Eras Medium ITC"><strong>QUINTA: </strong> Las partes acuerdan que el monto del derecho de uso durante el plazo de vigencia previsto para el presente contrato asciende a S/. ({{$contrato->cont_monto}} Soles y 00/100).</FONT></p>
      <p style="text-align: justify;"><FONT FACE="Eras Medium ITC"> Dicho monto será pagado en forma fraccionada en <strong>{{$contrato->Convenio->conv_nrocuota}}</strong> cuota(s) mensuales conforme al cronograma que forma parte del presente contrato y que ha sido aprobado mediante Resolución de Gerencia de Servicios Vecinales Nro. ..... </FONT></p>
          ...
          <table border="1">
            <thead>
              <tr>
                ...
                <th class="secondary-text">
                    <div class="table-header">
                        <span class="column-title">Concepto de Cuota</span>
                    </div>
                </th>
              </tr>
            </thead>
                ...
                <tbody>
                    @foreach ($planpagos as $ppago)
                        ...
                        @if($ppago->ppago_saldocuota>0 && $ppago->ppago_fechaven < $now)
                            <tr style="background-color: #FFA6A2">
                        @endif
                        @if($ppago->ppago_saldocuota>0 && $ppago->ppago_fechaven > $now)
                            <tr style="background-color: #C7E3FF">
                        @endif
      ...
      <p style="text-align: justify;"><FONT FACE="Eras Medium ITC"> Asimismo, se señala expresamente con el Reglamento de Cementerios de la Municipalidad, sobre el valor correspondiente al derecho de uso se ésta aplicando una tasa de interés compensatorio anual del 15%.</FONT></p>
      <p style="text-align: justify;"><FONT FACE="Eras Medium ITC"> Finalmente, se hace constar que conforme con el referido Reglamento, el incumplido de pago de dos cuotas consecutivas dará lugar a la pérdida del beneficio teniéndose por vencidas todas las cuotas, pudiendo darse inicio al procedimiento de cobranza y/o reversión del nicho.</FONT></p>
      <p style="text-align: justify;"><FONT FACE="Eras Medium ITC"><strong>SEXTA: </strong>El monto convenido en la cláusula precedente comprende únicamente a la cesión de uso propiamente dicho, no asi los costos por autorización para la instalación de lápidas, emblemas o epitafios, y para la construcción de cualquier clase de obras. El otorgamiento de este tipo de autorizaciones está sujeto al pago de la tasa correspondiente establecida en el TUPA de la Municipalidad.</FONT></p>
      <p style="text-align: justify;"><FONT FACE="Eras Medium ITC"> En todos los casos, está normado que no se autorizará la colocación de lápidas o placa a las personas naturales y/o jurídicas que hayan comprado nichos al crédito, sino hasta su cancelación.</FONT></p>
