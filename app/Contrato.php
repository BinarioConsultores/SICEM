...
class Contrato extends Model
{
  ...
  protected $fillable = [
        'cont_fecha', 'cont_tipopago','cont_concepto','cont_estado','cont_tipouso','cont_tiempo', 'cont_monto', 'cont_diffechsep', 'sol_id', 'dif_id', 'nicho_id', 'usu_id_reg', 'usu_id_auto','bolde_id', 'conv_id',
  ];
